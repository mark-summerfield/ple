...
import TrackForm
from Const import (
    APPNAME, ERROR_FG, HISTORY_LEN, PAUSE_ICON, PLAY_ICON, VERSION,
    Bookmark)
...
class ActionMixin:
    ...
    def add_to_history(self):
        new_item = Bookmark(self.playlists_pane.treeview.focus(),
        ...
        while len(config.history) > HISTORY_LEN:
            config.history.pop()
        self.update_history()
